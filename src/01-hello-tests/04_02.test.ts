import {CityType, demolishHousesOnTheStreet, getBuildingsWithCorrectStaffCount} from "./04_02";
...
test("Demolish houses on Happy street", () => {
...
test("buildings with correct staff count", () => {
    let buildings = getBuildingsWithCorrectStaffCount(
